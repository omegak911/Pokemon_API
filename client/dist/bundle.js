...
var _PokemonProfile = __webpack_require__(54);

var _PokemonProfile2 = _interopRequireDefault(_PokemonProfile);

var _Search = __webpack_require__(55);

var _Search2 = _interopRequireDefault(_Search);

var _PokemonSearchHistory = __webpack_require__(56);

var _PokemonSearchHistory2 = _interopRequireDefault(_PokemonSearchHistory);
...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    _this.changeShowPokemonVal = _this.changeShowPokemonVal.bind(_this);
    _this.componentDidMount = _this.componentDidMount.bind(_this);
    _this.requestFromServer = _this.requestFromServer.bind(_this);
    _this.displayPokemon = _this.displayPokemon.bind(_this);
    _this.getRequest = _this.getRequest.bind(_this);
    return _this;
  }

  _createClass(App, [{
    key: 'changeShowPokemonVal',
    value: function changeShowPokemonVal(e) {
      if (e.target) {
    ...
    value: function requestFromServer() {
      var _this2 = this;
      ...
      _axios2.default.post('/pokemon', { name: requestedPokemon }).then(function () {
        console.log('POST success!');
        var query = { params: { name: requestedPokemon } };
        _this2.getRequest(query);
    ...
    value: function getRequest(query) {
      ...
      var url = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '/pokemon';

      _axios2.default.get(url, query).then(function (_ref) {
        var data = _ref.data;

        console.log('GET success!', data);
        _this3.setState({ pokeList: [].concat(_toConsumableArray(_this3.state.pokeList), _toConsumableArray(data)), currentPokemon: data[0] });
      }).catch(function (err) {
    ...
    value: function displayPokemon() {
      ...
      var checkPokeList = pokeList.filter(function (pokemon) {
    ...
    value: function render() {
      var _state = this.state,
          currentPokemon = _state.currentPokemon,
          showPokemon = _state.showPokemon,
          pokeList = _state.pokeList;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(_PokemonProfile2.default, { currentPokemon: currentPokemon })
        ),
        ...
        _react2.default.createElement(
          'div',
          { className: 'searchHist' },
          _react2.default.createElement(_PokemonSearchHistory2.default, { changeShowPokemonVal: this.changeShowPokemonVal, pokeList: pokeList })
        )
      );
    }
  }]);
...
var PokemonProfile = function PokemonProfile(_ref) {
  var currentPokemon = _ref.currentPokemon;
  return _react2.default.createElement(
    "div",
    { className: "pokemonProfile" },
    _react2.default.createElement("img", { src: currentPokemon.picture, alt: "pokePic" }),
    _react2.default.createElement(
      "h4",
      null,
      currentPokemon.name
...
exports.default = PokemonProfile;
...
var Search = function Search(_ref) {
  var changeShowPokemonVal = _ref.changeShowPokemonVal,
      displayPokemon = _ref.displayPokemon,
      showPokemon = _ref.showPokemon;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement('input', { type: 'text',
        ...
        value: showPokemon,
        style: { width: 200 } }),
      _react2.default.createElement('input', { type: 'button', onClick: displayPokemon, value: 'Gotta Catch Them All!' })
    )
  );
};
...
var _PokemonSearchHistoryItem = __webpack_require__(57);

var _PokemonSearchHistoryItem2 = _interopRequireDefault(_PokemonSearchHistoryItem);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var PokemonSearchHistory = function PokemonSearchHistory(_ref) {
  var changeShowPokemonVal = _ref.changeShowPokemonVal,
      pokeList = _ref.pokeList;
  return _react2.default.createElement(
    'div',
    null,
    pokeList.map(function (pokemon, index) {
      return _react2.default.createElement(_PokemonSearchHistoryItem2.default, { changeShowPokemonVal: changeShowPokemonVal, key: index, pokemon: pokemon });
    })
  );
};

exports.default = PokemonSearchHistory;
...
var PokemonSearchHistoryItem = function PokemonSearchHistoryItem(_ref) {
  var changeShowPokemonVal = _ref.changeShowPokemonVal,
      pokemon = _ref.pokemon;
  return _react2.default.createElement(
    "div",
    { className: "searchHistItems" },
    _react2.default.createElement("img", { onClick: function onClick() {
        return changeShowPokemonVal(pokemon);
      }, src: pokemon.picture }),
    _react2.default.createElement("br", null),
    pokemon.name
  );
...
exports.default = PokemonSearchHistoryItem;
